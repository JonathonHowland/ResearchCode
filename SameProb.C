//Code to run mulitple simulations in the same area with many different total events (same probablility)
...
void SameProb(){
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////
  //Fit multiple times for same proportion of events
  ...
  ofstream results;
  results.open("SameProportion.dat");
  ...
  for(int j=1; j<10; j++){
    for(int i=0; i<100; i++){
      ...
      //Probabilities
      double prob1 = 0.01; //Signal probability
    ...
    double q1 = 0.25;
    double q3 = 0.75;
    //cout << "Hello " << hSig->Integral() << endl;
    //cout << "Goodbye " << hBack->Integral() << endl;
    double medSig = hSig->GetQuantiles(3, val, q);
    //double medSig = hSig->GetQuantiles(1, &med);
    ...
    */
    ...
    double errSig = hSig->GetMeanError();
    double errBack = hBack->GetMeanError();
